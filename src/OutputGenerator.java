...
public class OutputGenerator {
    ...
    public OutputGenerator(ArrayList<ParsedLine> input) {
        ...
        this.outputJavascript = new ArrayList<>();
        scoping = new Stack<>();
    }
    ...
    private void pushMessage(Message message) {
        ...
        if (message.content.toLowerCase().contains("stop")) {
            pushLine("sendMessage(\"%stopstroking%\", 0);");
            return;
        }
        ...
        //Check the command before this message and if its SystemMessage make this a SMessage instead of a sendMessage
        ...
        for (LineComponent comp : message.messageComponents) {
            ...
            if (comp instanceof HashFunction) {
                ...
                outputMessage = "sendMessage(\"" + ((FollowUp) comp).followUp + "\");";
                pushLine(outputMessage);
                popScoping();
                return;
            }
